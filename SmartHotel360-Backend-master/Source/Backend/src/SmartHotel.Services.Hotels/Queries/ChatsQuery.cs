    ...
    public class ChatsQuery
    {
        ...
        public Task<IEnumerable<ChatResult>> GetDefaultChats()
        {
            return Task.FromResult(new[]
            {
                ...
                new ChatResult() { Id = 2, Name = "Bar Chat", Messages = new ObservableCollection<Message>{ new Message(){ Text = "Hi", User = "Kevin Bos", SendTime = DateTime.Now  }, new Message(){ Text = "Hey", User = "Jordi Schepers", SendTime = DateTime.Now }}},
