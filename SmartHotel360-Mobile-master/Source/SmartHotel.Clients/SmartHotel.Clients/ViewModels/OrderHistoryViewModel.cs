...
namespace SmartHotel.Clients.Core.ViewModels
{
    public class OrderHistoryViewModel : ViewModelBase
    {
        ...
        string search;
        IEnumerable<Repository.ShopOrderModel> orders;
            ...
            IHotelService hotelService)
        {
            ...
            orders = new List<Repository.ShopOrderModel>();
        ...
        public override async Task InitializeAsync(object navigationData)
        {
            try
            {
                ...
                Suggestions = new List<string>(orders.Select(c => c.ToString()));
            }
        ...
        Task NextAsync()
        {
            var order = orders.FirstOrDefault(c => c.ToString().Equals(Suggestion));
            if (order != null)
            {
                //return NavigationService.NavigateToAsync<ShopViewModel>(order);
            }
